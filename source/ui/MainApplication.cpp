...
namespace inst::ui {
    ...
    void MainApplication::OnLoad() {
        ...
        this->cfwinstpage = cfwInstPage::New();
        ...
        this->cfwinstpage->SetOnInput(std::bind(&cfwInstPage::onInput, this->cfwinstpage, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
